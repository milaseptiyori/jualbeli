...
<table border="0" align="center" style="width:700px;border:none;">
        <tr>
            ...
            <th style="text-align:left;">: <?php echo $b['beli_nofak'];?></th>
        ...
        <tr>
            ...
            <th style="text-align:left;">: <?php echo 'Rp '.number_format($b['beli_jml_uang']).',-';?></th>
        </tr>
        <tr>
            <th style="text-align:left;">Keterangan</th>
            <th style="text-align:left;">: <?php echo $b['beli_keterangan'];?></th>
...
$no=0;
    foreach ($data->result_array() as $i) {
        ...
        $nabar=$i['d_beli_barang_nama'];
        $satuan=$i['d_beli_barang_satuan'];
        
        $harjul=$i['d_beli_barang_harjul'];
        $qty=$i['d_beli_qty'];
        $diskon=$i['d_beli_diskon'];
