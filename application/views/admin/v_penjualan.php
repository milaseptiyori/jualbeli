    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <tr>
                    ...
                    <th style="width:300px;padding-bottom:5px;"><input type="text" name="nofak" value="<?php echo $this->session->userdata('nofak');?>" class="form-control input-sm" style="width:200px;" required readonly></th>
                ...
                <tr>
                    ...
                    <td>
                        <div class='input-group date' id='datepicker' style="width:200px;">
                            <input type='date' name="tgl" class="form-control" value="<?php echo $this->session->userdata('tglfak');?>" placeholder="Tanggal..." required/>
            ...
            <table>
                ...
                <tr>
                    <th><input type="text" name="kode_brg" id="kode_brg" class="form-control input-sm"> Cari Barang?<a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><small> Klik Disini</small></a></th>                     
                </tr>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2023';?> by Mila Septiyori</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
